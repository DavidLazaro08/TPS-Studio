...
/**
 * Servicio para abrir fondos en un editor externo.
 *
 * Localiza el archivo físico del fondo y lo abre con el editor configurado
 * por el usuario o, si no existe, con el editor predeterminado del sistema.
 */
public class ExternalEditorService {
    ...
    public void abrirEditor(ImagenFondoElemento fondo) {
        if (fondo == null || fondo.getRutaArchivo() == null) {
            AlertHelper.createAlert(
                    ...
                    "El fondo no tiene una ruta de archivo asociada."
            ).showAndWait();
            return;
        }
    ...
    private File localizarArchivo(ImagenFondoElemento fondo) {
        ...
        /*
         * Si la ruta guardada no existe, se intenta resolver el fondo dentro
         * de la carpeta del proyecto. Esto ayuda cuando el proyecto se ha movido
         * o cuando el fondo se guardó como FRENTE/DORSO dentro de /Fondos.
         */
